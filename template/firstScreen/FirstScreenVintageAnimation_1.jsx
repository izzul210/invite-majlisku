...
export default function FirstScreenVintage_1({
		...
		<div className='w-full  flex justify-center items-center'>
			<div
				...
				<div
					...
					<motion.div variants={childVariants}>
						<TextTitle className='text-[24px] font-medium text-center flex flex-col whitespace-pre-line tracking-wider uppercase '>
							{italic_title.split('\n').map((char, index) => (
