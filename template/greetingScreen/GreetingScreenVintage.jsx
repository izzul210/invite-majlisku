...
const greetingsColor = '#7590CC';
const titleColor = '#3C6FD2';
...
export default function GreetingScreenVintage({
	enable_bahasa = false,
	event_opening_title,
	host_details,
	event_title_2,
	...
	return (
		<div
			...
			style={{ minHeight: windowWidth < 500 ? windowWidth * 1.96 : 820 }}>
			<Image
				className='h-full z-0'
				src='/greeting-vintage.png'
				alt='Greeting Vintage'
				layout='fill'
				objectFit='cover'
